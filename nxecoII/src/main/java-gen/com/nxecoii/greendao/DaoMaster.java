...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        SprayDetailsDao.createTable(db, ifNotExists);
        ScheduleDataDao.createTable(db, ifNotExists);
        WaterDataDao.createTable(db, ifNotExists);
        DownloadDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        SprayDetailsDao.dropTable(db, ifExists);
        ScheduleDataDao.dropTable(db, ifExists);
        WaterDataDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(SprayDetailsDao.class);
        registerDaoClass(ScheduleDataDao.class);
        registerDaoClass(WaterDataDao.class);
